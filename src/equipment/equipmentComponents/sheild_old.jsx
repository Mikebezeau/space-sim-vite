...
function shieldObj() {
  ...
  this.getString = function (includeHeader) {
    var string =
      "<table><tr><th>Damage</th><th>Structure</th><th>Range</th><th>Accuracy</th><th>BV</th><th>Special</th><th>Other</th><th>Notes</th><th>Cost</th><th>Space</th></tr>"; /*
...
function initSheildUI() {
  ...
  $("#sliderSSC")
    ...
    .on("slidechange", function (e, ui) {
      ...
      $("#shieldStandardClassTxt").val(
        shieldRefObj.type[0].CP[newShieldObj.class] + " CP"
      );
  ...
  $("#sliderSAC")
    ...
    .on("slidechange", function (e, ui) {
      ...
      newShieldObj.class = ui.value;
      $("#shieldStandardClassTxt").val(
        shieldRefObj.type[1].CP[newShieldObj.class] + " CP"
      );
      updateShieldCP(newShieldObj);
    });
  ...
  $("#sliderSRC")
    ...
    .on("slidechange", function (e, ui) {
      ...
      newShieldObj.class = ui.value;
      $("#shieldStandardClassTxt").val(
        shieldRefObj.type[2].CP[newShieldObj.class] + " CP"
      );
      updateShieldCP(newShieldObj);
    });
  ...
  $("#sliderSPF")
    ...
    .on("slidechange", function (e, ui) {
      ...
      $("#shieldParryFactorTxt").val(
        shieldRefObj.parryFactor.CM[ui.value] + " CM"
      );
      updateShieldCP(newShieldObj);
    });
