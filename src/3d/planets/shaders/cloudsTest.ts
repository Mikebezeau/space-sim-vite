...
float cloudMask = fractalNoise(distortedP * 4.0 + vec3(u_time * 0.05));
cloudMask = smoothstep(0.4, 0.7, cloudMask); // Sharpen the noise to create cloud shapes

// Mix clouds with base texture
vec4 cloudColor = vec4(vec3(1.0), cloudMask); // White clouds
