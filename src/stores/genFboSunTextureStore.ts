...
const useGenFboSunTextureStore = create<genFboTextureStoreState>()(
  (set, get) => ({
    /*
  readShader: null,
  ...
  */
    ...
    initComputeRenderer: (renderer) => {
      ...
      set({
        sunShaderDataVariable: get().initShaderVariable(
          gpuCompute,
          sunTextureFS
        ),
      });
...
*/
    ...
    setUniforms: (
      ...
      if (textureMapOptions.stretchX)
        uniforms["u_stretchX"] = {
          value: textureMapOptions.stretchX.toFixed(1),
        };
      else uniforms["u_stretchX"] = { value: 1.0 };

      if (textureMapOptions.stretchY)
        uniforms["u_stretchY"] = {
          value: textureMapOptions.stretchY.toFixed(1),
        };
...
export default useGenFboSunTextureStore;
